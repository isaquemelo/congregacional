...
Send the folder "congregacional" to the default themes folder from WordPress `wp-content/themes` or send the zipball using the WordPress Theme Installer.
...
Base-theme used: [ODIN](https://github.com/wpbrasil/odin). 
