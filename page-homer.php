		...
		<div class="generalContent">
			...
			<?php if ( $query_slider -> have_posts() ) : ?>
				<?php while( $query_slider -> have_posts() ):
					...
					<div class="holdSlide fullSize">
						<section class="typeSlider <?php echo get_post_type();?> <?php if(get_field('ocupar_toda_tela')){ echo 'fullSize ';} ?>" style="<?php if (has_post_thumbnail()): ?>background: url('<?php  the_post_thumbnail_url(); ?>')<?php endif; ?><?php if (get_field('cor_de_fundo')){echo ';background-color:'; the_field('cor_de_fundo');}?>" id="1">
			...
			<?php if ( $query_informativo -> have_posts() ) : ?>
				<?php while( $query_informativo -> have_posts() ):
					...
					<section class="typeInformativo <?php echo get_post_type();?> <?php if(get_field('ocupar_toda_tela')){ echo 'fullSize ';} ?>" style="<?php if (has_post_thumbnail()): ?>	background: url('<?php  the_post_thumbnail_url(); ?>')<?php endif; ?><?php if (get_field('cor_de_fundo')){echo ';background-color:';the_field('cor_de_fundo');}?>" id="2">
						<div class="container">
			...
			<?php if ( $query_box -> have_posts() ) : ?>
				<section class="typeBox blocos_type <?php if(get_field('ocupar_toda_tela')){ echo 'fullSize ';} ?>" style="<?php if (get_field('cor_de_fundo')){echo ';background-color:';the_field('cor_de_fundo');}?>" id="3">
						<div class="container">
								<div class="row">
			...
			<?php if ( $query_agenda -> have_posts() ) :?>
				<section class="typeAgenda agenda_type" style="<?php if (has_post_thumbnail()): ?>background: url('<?php  the_post_thumbnail_url(); ?>')<?php endif; ?><?php if (get_field('cor_de_fundo')){echo ';background-color:';the_field('cor_de_fundo');}?>" id="6">
						<div class="container infoHD">
								<header class="infoHeader">
										<div class="peopleTitle">
											EVENTOS A SEGUIR
			...
			<?php if ( $query_contato -> have_posts() ) : ?>
				<?php while( $query_contato -> have_posts() ):
					...
					<section class="typeInformativo <?php echo get_post_type();?> <?php if(get_field('ocupar_toda_tela')){ echo 'fullSize ';} ?>" style="<?php if (has_post_thumbnail()): ?>background: url('<?php  the_post_thumbnail_url(); ?>')<?php endif; ?><?php if (get_field('cor_de_fundo')){echo ';background-color:';the_field('cor_de_fundo');}?>" id="9">
						<div class="container">
